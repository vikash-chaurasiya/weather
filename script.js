...
function showWeatherReport(weather){
    ...
    let city = document.getElementById('customCity');
    customCity.innerText = `${weather.name}, ${weather.sys.country}`;

    let tempHumisity = document.getElementById('humidity');
...
function getDataLocation(lat,lon){
    ...
    fetch('https://api.openweathermap.org/data/2.5/weather?lat=28.69&lon=76.92&appid=c711ea7ee5b118627a4a2ebce904a407&units=metric')
    .then(locWeather => {
